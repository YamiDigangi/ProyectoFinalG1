...
public class Clientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jbActualizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImgVistas/modificarConLapiz.png"))); // NOI18N
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
       ...
       Cliente cliente = new Cliente(dni, nombre, apellido, true);     
    ...
    private void jbActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbActualizarActionPerformed
        if (jtfId.getText() != null) {
            ...
            Cliente cliente = new Cliente(idCliente,dni,nombre,apellido,true);
